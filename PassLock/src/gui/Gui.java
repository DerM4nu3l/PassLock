...
public class Gui extends Application {
	...
	// bottom enhält alle Elemente unter top
	...
	public void start(Stage primaryStage) throws Exception {
		...
		// Vbox - Hauptlayout
		main.setSpacing(10);
		main.setPadding(new Insets(8, 8, 8, 16));
		...
		bottom.getChildren().addAll(scroll, right);
		...
		Scene scene = new Scene(main, 850, 700);
		...
		viewPass.setOnAction((e) -> {
			if (viewPass.isSelected()) {
				...
				try {
					...
					passwordText.setFill(javafx.scene.paint.Color.BLACK);
				} catch (Exception except) {
					password = "Masterpasswort falsch!";
					passwordText.setFill(javafx.scene.paint.Color.RED);
				}
